...
namespace HoloToolkit.Examples.InteractiveElements
{
    ...
    /// </summary>
    public class DragDropButton : Interactive, ISourceStateHandler
    {
        /// <summary>
        /// Gesture Manipulation states
        /// </summary>
        //public enum GestureManipulationState { None, Start, Update, Lost }
        public GestureInteractive.GestureManipulationState GestureState { get; protected set; }
        ...
        public static void ClearGestureModalInput(GameObject source)
        {
            ...
            DragDropButton gesture = source.GetComponent<DragDropButton>();
            if (gesture == null)
            {
                return;
            }
        ...
        private void HandleStartGesture()
        {
            ...
            Control.ManipulationUpdate(mStartHandPosition, mStartHandPosition, mStartHeadPosition, mStartHeadRay, GestureInteractive.GestureManipulationState.Start);
            HandleCursor(true);
        }
        ...
        public override void OnInputUp(InputEventData eventData)
        {
            ...
            if(isHold)
            {
                ObjectPlacer.Instance.FinishDragAndDrop();
                isHold = false;
            }
        ...
        private void HandleRelease(bool lost)
        {
            ...
            Control.ManipulationUpdate(
                ...
                mStartHeadPosition,
                mStartHeadRay,
                lost ? GestureInteractive.GestureManipulationState.Lost : GestureInteractive.GestureManipulationState.None);
        ...
        protected override void Update()
        {
            ...
            if (mCurrentInputSource != null)
            {
                ...
                Control.ManipulationUpdate(mStartHandPosition, mCurrentHandPosition, mStartHeadPosition, mStartHeadRay, GestureInteractive.GestureManipulationState.Update);
            }
        }
